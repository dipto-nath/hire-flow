 ...
 */
async function mapCandidateToRequirements(
  resumeText: string,
  requirements: { id: string; type: string; category: string; label: string; description?: string }[]
 ...
 */
async function determineCandidateGroup(matches: RequirementMatch[]): Promise<CandidateGroupResult> {
