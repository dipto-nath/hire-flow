...
export async function candidateRoutes(app: FastifyInstance) {
  ...
  app.get('/:id', async (request, reply) => {
    const { id } = request.params as CandidateParams;
  ...
  app.post('/', async (request, reply) => {
    const data = request.body as CreateCandidateInput;
  ...
  app.patch('/:id', async (request, reply) => {
    const { id } = request.params as CandidateParams;
    const data = request.body as UpdateCandidateInput;
  ...
  app.patch('/:id/stage', async (request, reply) => {
    const { id } = request.params as CandidateParams;
    const { stage } = request.body as MoveStageInput;
  ...
  app.patch('/:id/group', async (request, reply) => {
    const { id } = request.params as CandidateParams;
    const { group } = request.body as OverrideGroupInput;
