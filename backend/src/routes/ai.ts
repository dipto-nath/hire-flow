...
export async function aiRoutes(app: FastifyInstance) {
  ...
  app.post('/map-candidate', async (request, reply) => {
    const data = request.body as MapCandidateInput;
  ...
  app.post('/generate-questions', async (request, reply) => {
    const data = request.body as GenerateQuestionsInput;
  ...
  app.post('/generate-followup', async (request, reply) => {
    const data = request.body as GenerateFollowUpInput;
  ...
  app.post('/synthesize-interview', async (request, reply) => {
    const data = request.body as SynthesizeInterviewInput;
  ...
  app.post('/generate-evaluation', async (request, reply) => {
    const data = request.body as GenerateEvaluationInput;
    ...
    try {
      const evaluation = await aiService.generateEvaluationReport(
        parsed.data.candidateId,
        parsed.data.interviewId
      );
